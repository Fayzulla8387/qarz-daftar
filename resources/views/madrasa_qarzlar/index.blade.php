...
@section('izlash')
    ...
    <div class="d-flex align-items-center">
        <button data-bs-toggle="modal" data-bs-target="#modal_qarzdor_yaratish" type="button" class="btn m-1" style="color: #ffffff; background-color: #086f62"><i class="fa fa-user-plus" >Yaratish</i></button>
        ...
        <div class="">
            <select id="izlash1"  name="qarzdor">
                ...
                @foreach($qarzdorlar as $qarzdor)
                    <option style="color: black; font-weight: bolder" value="{{$qarzdor['id']}}">{{$qarzdor['name']}} - {{$qarzdor['phone']}}</option>

                @endforeach

                <option disabled value="">____________________________________________________________________________________</option>
            </select>
        </div>
    </div>
@endsection
@section('content')
    <div class="card" id="kattadiv"  style="display: none; box-shadow: 0px 0px 5px 5px #c3c3ca; color: black; border-top: 5px solid #0b0b5b; border-bottom: 2px solid #0d0d54">
            ...
            <div class="float-end">
                <div class="" style="">
                        ...
                        <table>
                            <tr>
                                <th>
                                    <button data-bs-toggle="modal" data-bs-target="#modal_qazberish" style="color: #ffffff;background-color: #1157c1;font-weight: bolder" type="button" class="btn m-1"><i class="fas fa-plus"></i> Qarz berish</button>
                                </th>
                                <th>
                                    <form action="{{route('tarix')}}" method="post"> @csrf
                                        <input type="hidden" name="qarzdor_id" class="qarzdor_id" value="">
                                    <button  style="color: #ffffff;background-color: #4f3c71;font-weight: bolder" type="submit" class="btn  m-1" ><i class="fa fa-file"></i> Tarix</button>
                                    </form>
                                </th>
                                <th>
                                    <button data-bs-toggle="modal" data-bs-target="#modal_qarzdor_tahrirlash"  style="color: #ffffff;background-color: #037ea4;font-weight: bolder" type="button" class="btn m-1"><i class="fas fa-pen"></i> Tahrirlash</button>

                                </th>
                                <th>
                                    <button data-bs-toggle="modal" data-bs-target="#modal_qazbuzish"  style="color: black;background-color: #e1bf07;font-weight: bolder" type="button" class="btn  m-1" ><i class="fa fa-credit-card"></i> Qarz uzish</button>
                                ...
                                <th>
                                    <form id="form1" action="{{route('bitta-sms-jonat')}}" method="post">
                                        @csrf
                                        <input type="hidden" name="qarzdor_id" class="qarzdor_id" value="">
                                        <button  style="color: #ffffff;background-color: #0b0b5b;font-weight: bolder" type="submit" class="btn m-1"><i class="fa fa-paper-plane"></i> SMS</button>
                                    </form>
                                </th>
                            </tr>
                        </table>
        ...
        <div class="card-footer"><span style=" font-size: 20px;font-weight: bolder; color: #4d1111" id="eslatma"></span></div>
    </div>
                ...
                <div class="modal-body">
                    <form action="{{route('qarz_berish')}}" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="qarz_miqdori" required class="form-control" id="exampleInputEmail1">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" name="qaytarish_muddati" required  class="form-control qaytarish_muddati" id="exampleInputEmail1">
                        </div>

                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Yopish</button>
                            <button type="submit" class="btn " style="background-color: #0d0d54; color: white; font-weight: bolder"><i class="fa fa-save"></i> Saqlash</button>
                        </div>
                    </form>
            ...
            <div style="border-top: 4px solid #0b0b5b;border-bottom: 4px solid #0b0b5b" class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{route('qarz_uzish')}} " method="post">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Yopish</button>
                            <button type="submit" class="btn btn-primary" style="background-color: #0d0d54; color: white; font-weight: bolder"><i class="fa fa-save"></i> Saqlash</button>
                        </div>
                    </form>
                </div>
    ...
    <div class="modal fade" id="modal_qarzdor_yaratish" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div style="border-top: 4px solid #0b0b5b;border-bottom: 4px solid #0b0b5b" class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <form action="{{route('qarzdor_yaratish')}}" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="phone" value="{{old('phone')}}" required class="form-control" id="exampleInputEmail1">
                        </div>
                        <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label">Qarz miqdori:</label>
                            <input type="number" name="debt" value="{{old('debt')}}" required class="form-control" id="exampleInputEmail1">
                        </div>
                        <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label">Izoh:</label>
                            <input type="text" name="caption" value="{{old('caption')}}" class="form-control" id="exampleInputEmail1">
                        </div>
                        <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label">Qaytarish muddati:</label>
                            <input type="date" name="return_date" value="{{old('return_date')}}" required class="form-control" id="exampleInputEmail1">
                        </div>
    ...
    <div class="modal fade" id="modal_qarzdor_tahrirlash" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div style="border-top: 4px solid #0b0b5b;border-bottom: 4px solid #0b0b5b" class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <form action="{{route('qarzdor_tahrirlash')}}" method="post">
                        ...
                        <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label">Telefon raqam:</label>
                            <input type="number text" name="telefon" required class="form-control" id="edit_tel">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label">Alohida izoh:</label>
